...
// mppi_controller (GPU), both loaded through pluginlib exactly as
...
std::vector<Config> benchmarkConfigs(bool include_motion_models)
{
  std::vector<Config> configs = {
    ...
    {"gpu_mppi_K2048", "mppi_controller::MppiController", 2048},
    {"gpu_mppi_K8192", "mppi_controller::MppiController", 8192},
    {"gpu_mppi_K16384", "mppi_controller::MppiController", 16384},
    {"gpu_mppi_K65536", "mppi_controller::MppiController", 65536},
  };
  if (include_motion_models) {
    configs.push_back(
      {"gpu_ackermann_K8192", "mppi_controller::MppiController", 8192, "Ackermann"});
    configs.push_back(
      {"gpu_omni_K8192", "mppi_controller::MppiController", 8192, "Omni"});
  }
  return configs;
}
...
{
  return {
    {"gpu_costmap_K8192", "mppi_controller::MppiController", 8192},
    {"gpu_esdf_K8192", "mppi_controller::MppiController", 8192,
      "DiffDrive", 12.0, 0.8},
  };
}
...
{
  return {
    {"gpu_costmap_K8192_no_path_angle", "mppi_controller::MppiController", 8192,
      "DiffDrive", 0.0, 0.75, 0.0},
    {"gpu_costmap_K8192_path_angle", "mppi_controller::MppiController", 8192,
...
{
  return {
    {"gpu_costmap_K8192_no_curvature_speed", "mppi_controller::MppiController", 8192,
      "DiffDrive", 0.0, 0.75, 0.25, 0.0, 0.18},
    {"gpu_costmap_K8192_curvature_speed", "mppi_controller::MppiController", 8192,
